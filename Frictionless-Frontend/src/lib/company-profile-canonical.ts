...
export function buildCanonicalCompanyProfile(rawSources: RawSources): CanonicalCompanyProfile {
  ...
  return {
    ...
    keywords,
    industries,
    problem: init.problem || init.problem_statement || null,
    solution: init.solution || init.solution_summary || null,
    unique_value_proposition: init.unique_value_proposition || init.uvp || null,
    why_now: init.why_now || null,
    traction: init.traction || init.traction_summary || init.milestones || null,
